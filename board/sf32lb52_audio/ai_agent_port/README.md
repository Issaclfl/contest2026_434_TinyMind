...
构建产物 `out/sifli_sf32lb52_devkit_lcd_ai_agent/nuttx.bin`，md5 `af4e83e00cff`：

| 区域 | 占用 | 容量 | 占比 |
|---|---|---|---|
| flash | 2,185,240 B | 16 MB | 13.03% |
| sram | 153,024 B | 512 KB | 29.19% |
| psram | 0 B | 8 MB | 0%（尚未启用为堆区） |

相比仅含音频驱动的基线（1,451,508 B），Agent 增加约 **717 KB**。
